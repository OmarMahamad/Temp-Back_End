...
| Version | Supported          | الملاحظات |
| -------- | ------------------ | --------- |
| 1.x.x    | ✅ Supported       | الإصدارات الحالية تتلقى تحديثات أمان منتظمة |
| 0.x.x    | ❌ Not Supported   | لم تعد مدعومة، يُنصح بالترقية إلى أحدث إصدار |
...
We will acknowledge your report within **48 hours** and keep you updated throughout the process until the issue is resolved.

---

### 🔒 سياسة الأمان (بالعربية)
...
شكرًا لمساهمتك في الحفاظ على أمان المشروع ❤️
